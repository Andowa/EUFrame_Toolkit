<?php 
namespace library\EssentialUnifiedPage;
/**
       * --------------------------------------------------------       
       *  |         _____     _   _                           |           
       *  |        | ____|   | | | |                          |            
...
/**
 * 实例化分页
 * 示例:$Page=new EUPage($totalpage,$page,$pagenum,$pagelink);echo $Page->ShowPager();
 * 默认支持bootstrap样式
 */
class EUPage{
    var $nums;
    ...
    var $subpage_type;
    var $_lang = array( 
        'index_page' => '<eu data-localize="l.firstpage">首页</eu>', 
        'pre_page' => '<eu data-localize="l.previouspage">上页</eu>', 
        'next_page' => '<eu data-localize="l.nextpage">下页</eu>', 
        'last_page' => '<eu data-localize="l.lastpage">尾页</eu>', 
        'current_page' => '', 
        'total_page' => '<eu data-localize="l.totalpage">总页数</eu>:', 
        'current_show' => '<eu data-localize="l.currentpage">当前显示</eu>:', 
        'total_record' => '<eu data-localize="l.totalnum">总记录数</eu>:'
    ); 
    ...
    function PageListOne(){ 
        ...
        $subPageCss1Str."<li class='paginate_button page-item disabled'><a class='page-link eu-disabled'>". $this->_lang['current_page'] . $this->current_page." / " .$this->pagenums."</a></li>"; 
        if($this->current_page > 1){ 
            ...
            $subPageCss1Str.="<li class='paginate_button page-item disabled'><a class='page-link eu-disabled'>{$this->_lang['index_page']}</a></li>"; 
            $subPageCss1Str.="<li class='paginate_button page-item disabled'><a class='page-link eu-disabled'>{$this->_lang['pre_page']}</a></li>"; 
        }   
        if($this->current_page < $this->pagenums){ 
            ...
            $subPageCss1Str.="<li class='paginate_button page-item disabled'><a class='page-link eu-disabled'>{$this->_lang['next_page']}</a></li>"; 
            $subPageCss1Str.="<li class='paginate_button page-item disabled'><a class='page-link eu-disabled'>{$this->_lang['last_page']}</a></li>"; 
        } 
    ...
    function PageListTwo(){ 
	    ...
	    $subPageCss2Str.="<li class='paginate_button page-item disabled'><a class='page-link eu-disabled'>".$this->_lang['current_page'] . $this->current_page."/" . $this->pagenums."</a></li>"; 
	    if($this->current_page > 1){ 
		    $firstPageUrl=$this->subpage_link."1"; 
		    $prewPageUrl=$this->subpage_link.($this->current_page-1); 
		    ...
		    $subPageCss2Str.="<li class='paginate_button page-item disabled'><a class='page-link eu-disabled'>{$this->_lang['index_page']}</a></li>"; 
		    $subPageCss2Str.="<li class='paginate_button page-item disabled'><a class='page-link eu-disabled'>{$this->_lang['pre_page']}</a></li>"; 
	    } 
	    ...
	    if($this->current_page < $this->pagenums){ 
		    ...
		    $subPageCss2Str.="<li class='paginate_button page-item disabled'><a class='page-link eu-disabled'>{$this->_lang['next_page']}</a></li>"; 
	        $subPageCss2Str.="<li class='paginate_button page-item disabled'><a class='page-link eu-disabled'>{$this->_lang['last_page']}</a></li>"; 
	    } 
