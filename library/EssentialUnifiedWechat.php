<?php
namespace library\EssentialUnifiedWechat;
...
class EUWechat{
    ...
    public function ResponseMsg(){
        ...
        if(!empty($data)){
            ...
            if($obj->Ticket){
                ...
                EUInc::MakeDir(APP_ROOT."/log/wechat/ticket/");
                ...
                $time=$obj->CreateTime;
                EUInc::MakeDir(APP_ROOT."/log/wechat/");
                $jsonurl=APP_ROOT."/log/wechat/".$openid.".json";
                //存放事件日志
                //重复消息过滤
    ...
    public function GetLocal($type,$mediaid){
        ...
        EUInc::MakeDir(APP_ROOT."/assets/upload/wechat/");
        if($type=="voice"){
