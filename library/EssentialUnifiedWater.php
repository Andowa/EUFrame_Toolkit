<?php
namespace library\EssentialUnifiedWater;
/**
       * --------------------------------------------------------       
       *  |         _____     _   _                           |           
       *  |        | ____|   | | | |                          |            
...
/**
 * 水印
 * 文字:EUWater::MarkWater("text","1.jpg","essentialunified.com",5,"#B5B5B5","14");
 * 图片:EUWater::MarkWater("image","1.jpg","water.png",8);
*/
class EUWater{
    /**
    ...
    */
    public static function MarkWater($type,$photo,$content,$waterpos,$fontcolor='#B5B5B5',$fontsize='14'){
        $fontcolor=EUWater::Hex2Rgb($fontcolor);
