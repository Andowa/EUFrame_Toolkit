<?php
namespace library\EssentialUnifiedTree;
...
class EUTree{
     ...
     * @return string
     */
    function GetTreeView($id,$effected_id='ESSENTIALUNIFIED',$str="<span class='file'>\$name</span>", $str2="<span class='folder'>\$name</span>" ,$showlevel = 0 ,$style='filetree' , $currentlevel = 1,$recursion=FALSE) {
        $child = $this->GetChild($id);
        ...
        $data.="<ul id='cat'>";
            foreach($cats as $a){
                if($a["bid"]==0){
                    ...
                    $thedata=EUData::QueryData($table,"",$catfield."=".$a["id"],"id desc","0,".$querynum)["querydata"];
