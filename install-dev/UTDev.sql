...
CREATE TABLE `cms_admin` (
  `id` int(11) NOT NULL AEUO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)) ENGINE=InnoDB AEUO_INCREMENT=1 DEFAULT CHARSET=utf8;
...
CREATE TABLE `cms_api_set` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB AEUO_INCREMENT=1 DEFAULT CHARSET=utf8;
...
INSERT INTO `cms_admin_role` VALUES (1, '超级管理', 'eu-frame,eu-module,eu-plugin,eu-template,eu-cac,eu-system,eu-data,eu-api,eu-power');
INSERT INTO `cms_api_set` VALUES (1, NULL, NULL, 'cms_admin', 'username=[0] and password=[1]');
INSERT INTO `cms_module` VALUES (1, 3, 'eu-frame', 'EU公共模块', 'index.php', 1, 91, 0, '', NULL, NULL);
INSERT INTO `cms_module` VALUES (2, 3, 'eu-module', '模块', 'index.php', 1, 92, 0, '', '', '模块市场:module.php,管理模块:index.php');
INSERT INTO `cms_module` VALUES (3, 3, 'eu-plugin', '插件', 'index.php', 1, 93, 0, '', '', '插件市场:plugin.php,管理插件:index.php');
INSERT INTO `cms_module` VALUES (4, 3, 'eu-template', '模板', 'index.php', 1, 94, 0, '', '', '模板市场:template.php,创建模板:template_creat.php,管理模板:index.php');
INSERT INTO `cms_module` VALUES (5, 3, 'eu-cac', 'CAC', 'index.php', 1, 95, 0, '', '', '');
INSERT INTO `cms_module` VALUES (6, 3, 'eu-system', '配置', 'index.php', 1, 96, 1, '', '', '系统:index.php,语言:lang.php,搜索:search.php');
INSERT INTO `cms_module` VALUES (7, 3, 'eu-data', '数据', 'index.php', 1, 97, 1, '', '', '表管理:index.php,SQL查询:sql.php,备份还原:backup.php');
INSERT INTO `cms_module` VALUES (8, 3, 'eu-api', '接口', 'index.php', 1, 98, 1, '', '', '接口列表:index.php,在线调试:test.php');
INSERT INTO `cms_module` VALUES (9, 3, 'eu-power', '权限', 'admin.php', 1, 99, 1, '', '', '角色:role.php,管理员:admin.php,登陆日志:log.php');